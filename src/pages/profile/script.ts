function handleOnClick(showDiv:string, hideFirstDiv:string, hideSecondDiv:string) {
...
document.getElementById("changeInfo")?.addEventListener("click",()=>handleOnClick("editInfo","profileInfo","editPassword"))
document.getElementById("changePassword")?.addEventListener("click",()=>handleOnClick("editPassword","profileInfo","editInfo"))